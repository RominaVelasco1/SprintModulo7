...
urlpatterns = [
    ...
    path('completa_tareas/login/', tareas, name = 'index'),
    path('enProgreso_tareas/login/', tareas, name = 'index'),
    ...
    path('enProgreso_tareas/<id>/', enProgresoTareas, name = 'enProgreso_tareas'),
